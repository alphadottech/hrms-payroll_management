                                                        ...
                                                        <tr>
                                                            <td class="tw-card-body"
                                                                ...
                                                                <p class=""
                                                                    ...
                                                                    <label for="Employee_Id">Employee_Id</label>:-<a id = "Employee_Id" >${EmployeeId}</a><br>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="button__td "
                                                                                                style="border-radius: 7px; text-align: center; width: 523px;"> <a
                                                                                                    ...
                                                                                                    href="${approveLeaveRequestLink1}"
                                                                                                    target="_blank"
                                                                                                    rel="noopener">Confirm</a>
                                                                                                </td>
